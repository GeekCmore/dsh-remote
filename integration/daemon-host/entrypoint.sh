#!/bin/sh
# Verbatim copy of ../sshd/entrypoint.sh (PUBKEY injection + /home/dsh/work
# fixtures; the fixtures are unused by the daemon-mode smoke but harmless).
# Kept as a copy so integration/daemon-host stays a self-contained docker
# build context — see the comment in the sibling Dockerfile.
set -eu
