/**
 * Vendored from deepseek-ai/deepseek-harness (MIT), packages/fs/fs/src —
 * adapted to import sandbox vocabulary from `./sandbox.js` because
 * `@deepseek-ai/dsh-fs` cannot be installed standalone (unpublished dep).
 * Upstream version: 0.1.0-rc.5. Keep structurally aligned when upgrading.
 */
/**
...
import type { SandboxExecutionPolicy, SandboxMode } from './sandbox.js'
import type {
  FsDirEntry,
  FsEditOutcome,
  FsEditRequest,
