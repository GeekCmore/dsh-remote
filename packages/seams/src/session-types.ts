/**
 * Vendored from deepseek-ai/deepseek-harness (MIT), packages/core/session/src —
 * upstream version 0.1.0-rc.5. Type-level seam vocabulary for the daemon-mode
 * session protocol; keep aligned when upgrading.
 */
...
import type { JsonValue } from './session-json.js'
...
export type { JsonValue } from './session-json.js'
