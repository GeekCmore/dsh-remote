/**
 * Vendored from deepseek-ai/deepseek-harness (MIT), packages/subprocess/subprocess/src —
 * vendored because `@deepseek-ai/dsh-subprocess` cannot be installed standalone
 * (unpublished dep). Upstream version: 0.1.0-rc.5. Keep aligned when upgrading.
 */
/**
...
import { DSH_ENV_PREFIX } from './subprocess-types.js'
import type { SubprocessHandle, SubprocessSpawnSpec } from './subprocess-types.js'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from './subprocess-types.js'

export { DSH_ENV_PREFIX } from './subprocess-types.js'
export type {
  CollectedOutput,
  DshEnvironment,
  DshEnvironmentKey,
